...
class clustering(object):
   ...
   def agglomViz(self,affin,link,clusters):
      ...
      plt.title('Clusters of customers: Age vs Number of Products',size=14)
      plt.yticks(np.arange(0, 5, step=1))
      plt.xlabel('Age of Customer',size=12)
   ...
   def kMeansViz(self,clusterNum):
      ...
      plt.title('Clusters of customers: Age vs Number of Products')
      plt.xlabel('Age of Customer')
      plt.ylabel('Num of Products')
      plt.show()


csv_file = 'Confidence Export 3.csv'
first_column = 6
second_column = 8
number_clusters = 3
affinity = 'euclidean'
...
##hc1 = clustering(first_column,second_column,third_column,fourth_column,csv_file)
